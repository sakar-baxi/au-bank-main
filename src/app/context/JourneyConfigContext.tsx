...
const DEFAULT_LEGAL_TEXTS: LegalTexts = {
  ...
  vkycConsent: [
    ...
    "I authorize AU Bank to open my salary account using Aadhaar OTP-based e-KYC if Video KYC is unsuccessful.",
...
/* AU Bank preset - optimised for all 3 journeys (NTB, ETB, ETB-NK) */
export const IDFC_JOURNEY_PRESET: Partial<JourneyConfigState> = {
  bankName: "AU Bank",
  journeyName: "AU Bank Salary Account Opening",
  ctaLabels: {
    ...DEFAULT_CTA_LABELS,
    continue: "Continue",
    verifyOtp: "Verify & Continue",
  ...
  stepTitles: {
    ...
    heroSubtitle: "With your AU Bank Salary Account",
  ...
  legalTexts: {
    ...DEFAULT_LEGAL_TEXTS,
    aadhaarConsent:
      "By proceeding I allow AU Bank to use my Aadhaar to fetch KYC details from UIDAI, fetch CIBIL report from TransUnion CIBIL and give consent to the bank to contact me via Call, SMS, Email and WhatsApp. This consent overrides any registration for DNC/NDNC.",
    nomineeDisclaimer:
      "In event of account holder's death, the amount of deposit in the account will be returned to the nominee by AU Bank.",
    kycDisclaimer:
    ...
    taxResidentDisclaimer:
      "I accept all terms & conditions related to AU Bank and confirm that I am citizen of only India, born in India and a tax resident of India only. Additionally, I confirm that I am not a politically exposed person nor related to one. For any change, I will visit the nearest branch and update my details.",
...
const DEFAULT_JOURNEY_CONFIG: JourneyConfigState = {
  journeyId: "default",
  journeyName: IDFC_JOURNEY_PRESET.journeyName ?? "AU Bank Salary Account Opening",
  bankName: IDFC_JOURNEY_PRESET.bankName ?? "AU Bank",
  journeyMode: "form",
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      try {
        ...
        if (!ctx) {
          resolve({ primary: "#42265e", secondary: "#c84417", accent: "#f5f5f5" });
          return;
        }
