        ...
        {!isMinimized && (
          <div className="flex-1 overflow-y-auto px-8 pb-10 space-y-10 relative z-10 scrollbar-hide">
                  ...
                  {activeNudge && (
                    ...
                    >
                      ...
                      <div className="flex-1 overflow-hidden">
                        <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none mb-1">AU Bank</p>
            ...
            <div className="bg-white/80 backdrop-blur-2xl rounded-[40px] border border-white shadow-premium overflow-hidden transition-all hover:shadow-premium-lg">
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-3 gap-3">
                  <button
                    onClick={() => addNotification("AU Bank", "SMS: Please complete your AU Bank salary account journey. Click to resume.")}
                  ...
                  <button
                    onClick={() => addNotification("AU Bank", "WhatsApp: Your AU Bank salary account is waiting. Click to resume.")}
                  ...
                  <button
                    onClick={() => addNotification("AU Bank", "Email: Final reminder to complete your KYC for AU Bank salary account.")}
                ...
                <Button
                  onClick={() => {
                    addNotification("AU Bank", "Omnichannel Nudge sent successfully.");
                  }}
            ...
            <div className="text-center pt-8">
              <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.4em]">AU Bank Secure Node v2.0</p>
            </div>
          </div>
        )}
      </div>
