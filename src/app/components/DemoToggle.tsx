...
import { CreditCard, ArrowRight, Zap, MessageCircle, PiggyBank, MapPin, Car, GraduationCap } from "lucide-react";

const JOURNEY_TYPES: JourneyType[] = ["ntb", "ntb-conversion", "etb-nk", "etb", "conversational", "personal-loan", "auto-loan", "education-loan", "address-verification"];
...
const JOURNEY_DETAILS: Record<JourneyType, { label: string; icon: React.ElementType }> = {
  ...
  "auto-loan": { label: "Auto Loan (placeholder)", icon: Car },
  "education-loan": { label: "Education Loan (placeholder)", icon: GraduationCap },
  "address-verification": { label: "Address Verification", icon: MapPin },
};
