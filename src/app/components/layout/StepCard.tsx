...
export default function StepCard({ children, maxWidth = "6xl", step, className, noPadding }: StepCardProps) {
    return (
        <div className={cn("w-full mx-auto", MAX_WIDTH_CLASS[maxWidth] || MAX_WIDTH_CLASS["6xl"])}>
            <div className={cn("enterprise-card w-full", noPadding && "p-0", className)}>
                {step && (
                    <div
