...
export default function StepAccountConversion() {
        ...
        return (
            <div className="space-y-6">
                <AgentMessage isNew={false}>
                    Account verified successfully! I've linked your existing AU Bank portfolio to your new Priority benefits.
                </AgentMessage>
    ...
    return (
        <div className="space-y-6 w-full animate-in slide-in-from-bottom-8 duration-700">
            <AgentMessage>
                Let's secure your connection! 🛡️ Please verify your existing AU Bank account to unlock direct conversion benefits and skip redundant documentation.
            </AgentMessage>
            ...
            <div className="pl-14 space-y-10">
                <div className="bg-white rounded-[40px] shadow-premium-lg border border-slate-50 overflow-hidden">
                    {/* AU Bank Verification Header */}
                    <div className="bg-slate-900 px-10 py-6 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <ShieldCheck className="w-6 h-6 text-blue-400" />
                            <h2 className="text-lg font-black text-white uppercase tracking-tight">AU Bank Secure Login</h2>
                        </div>
