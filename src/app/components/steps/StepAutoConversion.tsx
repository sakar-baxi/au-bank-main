              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    active ? "border-[#42265e] bg-blue-50/40" : "border-slate-200 bg-white hover:bg-slate-50",
                  ].join(" ")}
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div
                      className={[
                        ...
                        active ? "border-[#42265e]" : "border-slate-300",
                      ].join(" ")}
                    >
                      <div className={["h-2.5 w-2.5 rounded-full", active ? "bg-[#42265e]" : "bg-transparent"].join(" ")} />
                    </div>
                  </div>
                </button>
              );
