      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="space-y-3">
            {!disableDebitVerification && (
              <button
                ...
                className={[
                  ...
                  method === "debit" ? "border-[#42265e] bg-blue-50/40" : "border-slate-200 bg-white hover:bg-slate-50",
                ].join(" ")}
              >
                ...
                <div
                  className={[
                    ...
                    method === "debit" ? "border-[#42265e]" : "border-slate-300",
                  ].join(" ")}
                >
                  <div className={["h-2.5 w-2.5 rounded-full", method === "debit" ? "bg-[#42265e]" : "bg-transparent"].join(" ")} />
                </div>
              </button>
            )}
            ...
            <button
              ...
              className={[
                "w-full rounded-[var(--radius-lg)] border p-4 text-left transition-colors flex items-center gap-3",
                method === "netbanking" ? "border-[#42265e] bg-blue-50/40" : "border-slate-200 bg-white hover:bg-slate-50",
              ].join(" ")}
            >
              ...
              <div
                className={[
                  "h-5 w-5 rounded-full border-2 flex items-center justify-center",
                  method === "netbanking" ? "border-[#42265e]" : "border-slate-300",
                ].join(" ")}
              >
                <div
                  className={["h-2.5 w-2.5 rounded-full", method === "netbanking" ? "bg-[#42265e]" : "bg-transparent"].join(" ")}
                />
              </div>
            </button>
          </div>
          ...
          <div className="lg:col-span-2 rounded-xl border border-slate-200/80 bg-slate-50/50 p-5 space-y-4">
            ...
            <label className="flex items-center gap-2 text-xs font-semibold text-gray-800 cursor-pointer select-none">
              <Checkbox
                ...
                className="rounded-[var(--radius)] border-gray-300 data-[state=checked]:bg-[#42265e] data-[state=checked]:border-[#42265e]"
              />
