              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-gray-700 leading-relaxed">
                  {journeyConfig.legalTexts.aadhaarConsent ??
                    "I voluntarily authorize AU Bank to use my Aadhaar details for eKYC authentication and to fetch my KYC details from UIDAI for account opening. I indemnify AU Bank against losses arising due to any difference in my name on Aadhaar and PAN, if any."}
                </span>
              </label>
