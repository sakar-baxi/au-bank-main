    ...
    <StepCard maxWidth="6xl">
      ...
      <div className="space-y-4">
          ...
          return (
            <div
              ...
              className={[
                ...
                isSelected ? "border-[#42265e] bg-blue-50/40" : "border-blue-100 bg-blue-50/20 hover:border-[#42265e] hover:bg-blue-50/50",
              ].join(" ")}
            >
              <div className="w-12 h-12 rounded-xl bg-blue-50 group-hover:bg-blue-100 flex items-center justify-center flex-shrink-0 transition-colors">
                <FileText className="w-6 h-6 text-[#42265e]" />
              </div>
              ...
              <div className={["w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors", isSelected ? "border-[#42265e]" : "border-slate-200 group-hover:border-[#42265e]"].join(" ")}>
                <div className={["w-3 h-3 rounded-full bg-[#42265e] transition-opacity", isSelected ? "opacity-100" : "opacity-0 group-hover:opacity-100"].join(" ")} />
              </div>
            </div>
          );
        })()}
        ...
        {(() => {
          ...
          return (
            ...
            <div className={["w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors", isSelected ? "border-orange-600" : "border-slate-200 group-hover:border-[#42265e]"].join(" ")}>
      ...
      {selectedMethod === "physicalKyc" && (
        <div className="text-center">
          <button
            onClick={() => handleChoice("ekyc")}
            className="text-sm font-semibold text-[#42265e] hover:underline"
          >
